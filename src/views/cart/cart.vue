      ...
      <div class="allgoods">
        ...
        <div class="cart-main">
          ...
          <div class="cart-item-list">
            <div class="cart-shop">
              ...
              <span class="shopname self">新兴自营</span>
            </div>
            <div class="cart-body">
              <div class="cart-list">
                <ul class="goods-list yui3-g">
                  ...
                  <li class="yui3-u-11-24">
                    <div class="good-item">
                      <div class="item-img"><img src="../../../static/img/itemlike01.png" /></div>
                  ...
                  <!-- <li class="yui3-u-1-8">
                    <a href="#none">【赠品】魅阁10400毫安 移动电源 (图片仅供参考，详情以实物为准) X1</a>
                  </li> -->
                </ul>
              </div>
              <div class="cart-list">
        ...
        <div class="cart-tool">
          ...
          <div class="toolbar">
            ...
            <div class="sumbtn">
              <router-link :to="{ path: '/getOrderInfo' }" class="sum-btn" >结算</router-link>
            </div>
          </div>
        </div>
